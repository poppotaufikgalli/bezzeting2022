                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Progres OPD
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <?php 
                                                            $jmlopd = count($opd);
                                                            $jmlopdbaz = $rekap['progresopd'];
                                                            $percent = round(($jmlopdbaz / $jmlopd)*100, 2); 
                                                            echo $percent. "%"; 
                                                        ?>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-lg-12 mb-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tutorial Bezzeting 2022</h6>
                                </div>
                                <div class="card-body text-center">
                                    <video controls="controls" width="800" height="600" name="Video Name">
                                        <source src="<?=base_url('asset/tutorial bz2022-sm.mov')?>">
